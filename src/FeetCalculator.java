...
public class FeetCalculator extends Application {
    ...
    private double sum, sum1, ultimateSum = 0;
...
//    private Text sumOfPerc = new Text();
//    private Button addPerc = new Button("Add charges");
    ...
    private Text result8 = new Text();
    private TextField rate8 = new TextField();
    private Button btCalculateQty8 = new Button("Calculate Qty.");
    private Button btAmount8 = new Button("Calculate Amt.");
...
//    private TextField extraPerc = new TextField();
    ...
    private Button ultimateCal = new Button("Calculate the total cost of estimate");
    ...
    public void start(Stage primaryStage) {
        ...
        gridPane.add(new Label("Enter Expression:"), 0, 51);
        gridPane.add(expression8, 1, 51);
        gridPane.add(new Label("Quantity:"), 2, 51);
        gridPane.add(result8, 3, 51);
        gridPane.add(new Label("Enter Rate % (it is per 100):"), 4, 51);
        gridPane.add(rate8, 5, 51);
        gridPane.add(new Label("Amount:"), 6, 51);
        gridPane.add(tAmt8, 7, 51);
        gridPane.add(btCalculateQty8, 1, 52);
        gridPane.add(btAmount8, 5, 52);
...
//        gridPane.add(xtraCB, 0, 74);

        /*for adding the options in rcc*/
//        gridPane.add(elecCB, 1, 75);
//        gridPane.add(elecPerc, 2, 75);
//        gridPane.add(sanitaryCB, 1, 76);
//        gridPane.add(sanitaryPerc, 2, 76);
//        gridPane.add(extraCB, 1, 77);
//        gridPane.add(extraPerc, 2, 77);
//        gridPane.add(addPerc, 1, 78);
//        gridPane.add(new Label("Total extra % charges"), 2, 78);
//        gridPane.add(sumOfPerc, 3, 78);
        ...
        gridPane.add(generate, 1, 78);
        gridPane.add(actionTarget, 2, 78);
        ...
        //for 8th one
        btCalculateQty8.setOnAction(event -> {
            result8.setText(String.valueOf(new ExpressionBuilder(expression8.getText()).build().evaluate()));
        });
        btAmount8.setOnAction(event -> {
            tAmt8.setText(String.valueOf((Double.valueOf(result8.getText()) * Double.valueOf(rate8.getText()) / 100)));
        ...
        //for adding the total % charges
//        addPerc.setOnAction(event -> {
//            a2.add(Double.parseDouble(elecPerc.getText()));
//            a2.add(Double.parseDouble(sanitaryPerc.getText()));
//            a2.add(Double.parseDouble(extraPerc.getText()));
//            for (int i = 0; i < a2.size(); i++) {
//                sum1 = sum1 + Double.parseDouble(a2.get(i).toString());
//            }
//            sumOfPerc.setText(String.valueOf(sum1));
//        });
        ...
        ultimateCal.setOnAction(event -> {
            ...
            //ultimateSum= ultimateSum+(Double.valueOf(sumOfPerc.getText())/100 * ultimateSum);
...
//                run = paragraph.createRun();
        ...
        if (tankFlag) {
            ...
            paragraph = document.createParagraph();
            run = paragraph.createRun();
            run.setText(expression8.getText().replace("*", "X") + "    ");
            run.setText(" =" + result8.getText() + "    ");
            run.setText(rate8.getText() + "    ");
...
//                paragraph.setAlignment(ParagraphAlignment.LEFT);
//                run = paragraph.createRun();
//                run.setText("Electrical Charges = ");
//                run.setText(elecPerc.getText());
//            }
//            if (sanitaryFlag) {
//                //Create Another paragraph
//                paragraph = document.createParagraph();
...
//                paragraph.setAlignment(ParagraphAlignment.LEFT);
//                run = paragraph.createRun();
//                run.setText("Sanitary Charges = ");
//                run.setText(sanitaryPerc.getText());
//            }
//            if (extraFlag) {
//                //Create Another paragraph
//                paragraph = document.createParagraph();
...
//                paragraph.setAlignment(ParagraphAlignment.LEFT);
//                run = paragraph.createRun();
//                run.setText("Extra Charges = ");
//                run.setText(extraPerc.getText());
//            }
//            paragraph = document.createParagraph();
//            run = paragraph.createRun();
//            run.setText("-------------------------------------------------------------");
...
//            paragraph = document.createParagraph();
//            run = paragraph.createRun();
//            run.setText("Total " + sumOfPerc.getText() + "charges extra");
//        }

        //16 Create Another paragraph
        paragraph = document.createParagraph();
        //Set alignment paragraph to RIGHT
